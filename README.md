...
+ Configure Generic Database Connector in Global Elements section of the flow to use your database specific driver. Driver class name needs to be supplied here.
...
+ db.jdbcUrl `jdbc:mysql://database_host:3306/database_name?user=database_user&password=database_password`
